					...
					return (
						...
						(d.show = function () {
							...
							if (!this._isTransitioning && !e(this._element).hasClass(h.SHOW)) {
								...
								if (
									(this._parent &&
										((r = e.makeArray(e(this._parent).children().children(u.ACTIVES))).length ||
											(r = null)),
							...
							if (!this._isTransitioning && e(this._element).hasClass(h.SHOW)) {
								...
								if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
									...
									(this._element.style[i] = ''),
										s.supportsTransitionEnd()
											? e(this._element).one(s.TRANSITION_END, c).emulateTransitionEnd(600)
											: c();
								}
							}
						}),
						...
						(d._getConfig = function (n) {
							return (
								(n = e.extend({}, o, n)), (n.toggle = Boolean(n.toggle)), s.typeCheckConfig(t, n, a), n
							);
						}),
						...
						(m.show = function () {
							...
							if (this.isWithContent() && this._isEnabled) {
								...
								s.supportsTransitionEnd() && e(this.tip).hasClass(f.FADE)
									? e(this.tip).one(s.TRANSITION_END, g).emulateTransitionEnd(o._TRANSITION_DURATION)
									: g();
							}
						}),
						(m.hide = function (t) {
						...
						(o._jQueryInterface = function (t) {
							return this.each(function () {
								...
								if (
									...
									(n || ((n = new o(this, i)), e(this).data('bs.tooltip', n)), 'string' == typeof t)
								) {
									if ('undefined' == typeof n[t]) throw new Error('No method named "' + t + '"');
									n[t]();
								}
						...
						(d._jQueryInterface = function (t) {
							return this.each(function () {
								...
								if (
									...
									(n || ((n = new d(this, i)), e(this).data('bs.popover', n)), 'string' == typeof t)
								) {
									if ('undefined' == typeof n[t]) throw new Error('No method named "' + t + '"');
									n[t]();
								}
						...
						(n._jQueryInterface = function (t) {
							return this.each(function () {
								var i = e(this).data('bs.scrollspy'),
									s = 'object' == typeof t && t;
								if (
									(i || ((i = new n(this, s)), e(this).data('bs.scrollspy', i)), 'string' == typeof t)
								) {
