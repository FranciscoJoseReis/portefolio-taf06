...
var bootstrap = (function (t, e) {
	...
	function a(t) {
		...
		return n && 'BODY' !== n && 'HTML' !== n
			? -1 !== ['TD', 'TABLE'].indexOf(e.nodeName) && 'static' === r(e, 'position')
				? a(e)
				: e
	...
	function v(t, e) {
		var n = lt(),
			...
			d = m({ top: o.top - a.top - f, left: o.left - a.left - h, width: o.width, height: o.height });
	...
	function E(t) {
		var e = window.document.documentElement,
			...
			o = h(e),
			s = h(e, 'left');
		return m({ top: o - n.top + n.marginTop, left: s - n.left + n.marginLeft, width: i, height: r });
	}
	function T(t) {
		var e = t.nodeName;
	...
	function b(t, e, n, i) {
		...
		if ('viewport' === i) r = E(a);
			...
			var l = void 0;
			'scrollParent' === i
				? 'BODY' === (l = s(o(t))).nodeName && (l = window.document.documentElement)
	...
	function N(t, e, n) {
		return (
			(void 0 === n ? t : t.slice(0, w(t, 'name', n))).forEach(function (t) {
	...
	for (
		var X = (function () {
				...
				function i() {
					...
					for (var e in s) if ('undefined' != typeof t.style[e]) return { end: s[e] };
					return !1;
				}
				function r(t) {
					var n = this,
						...
						return (
							...
							(n._removeElement = function (t) {
								...
								e(t).removeClass(r.SHOW),
									X.supportsTransitionEnd() && e(t).hasClass(r.FADE)
										? e(t)
			...
			J = (function () {
				...
				return (
					e(document)
						.on(o.CLICK_DATA_API, r.DATA_TOGGLE_CARROT, function (t) {
							t.preventDefault();
							var n = t.target;
			...
			$ = (function () {
					...
					h = (function () {
						...
						return (
								...
								this._config.keyboard &&
									...
									'hover' === this._config.pause &&
										...
										('ontouchstart' in document.documentElement) &&
											e(this._element).on(l.TOUCHEND, function () {
												t.pause(),
							...
							(h._slide = function (t, n) {
								...
								if (
									(t === a.NEXT
										? ((i = c.LEFT), (r = c.NEXT), (o = a.LEFT))
										: ((i = c.RIGHT), (r = c.PREV), (o = a.RIGHT)),
									...
									var m = e.Event(l.SLID, { relatedTarget: d, direction: o, from: u, to: p });
									X.supportsTransitionEnd() && e(this._element).hasClass(c.SLIDE)
										? (e(d).addClass(r),
										  X.reflow(d),
										  e(h).addClass(i),
										  e(d).addClass(i),
							...
							(r._jQueryInterface = function (t) {
								return this.each(function () {
									...
									if ((i || ((i = new r(this, s)), e(this).data(n, i)), 'number' == typeof t))
										i.to(t);
				...
				return (
					e(document).on(l.CLICK_DATA_API, f.DATA_SLIDE, h._dataApiClickHandler),
			...
			tt = (function () {
						...
						return (
							...
							(f.show = function () {
								...
								if (!this._isTransitioning && !e(this._element).hasClass(a.SHOW)) {
									...
									if (
										(this._parent &&
											((r = e.makeArray(e(this._parent).children().children(c.ACTIVES))).length ||
												(r = null)),
										...
										if ((e(this._element).trigger(l), !l.isDefaultPrevented())) {
											...
											var h = function () {
												e(t._element)
													...
													e(t._element).trigger(s.SHOWN);
											};
											if (X.supportsTransitionEnd()) {
												var u = 'scroll' + (f[0].toUpperCase() + f.slice(1));
												e(this._element).one(X.TRANSITION_END, h).emulateTransitionEnd(600),
													(this._element.style[f] = this._element[u] + 'px');
											} else h();
										}
									}
								}
									...
									if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
										...
										if (
											...
											for (var r = 0; r < this._triggerArray.length; r++) {
												...
												null !== l &&
													(e(l).hasClass(a.SHOW) ||
														e(o).addClass(a.COLLAPSED).attr('aria-expanded', !1));
											}
										this.setTransitioning(!0);
										var c = function () {
											t.setTransitioning(!1),
										...
										(this._element.style[i] = ''),
											X.supportsTransitionEnd()
												? e(this._element).one(X.TRANSITION_END, c).emulateTransitionEnd(600)
												: c();
									}
								}
							}),
				...
				return (
					e(document).on(s.CLICK_DATA_API, c.DATA_TOGGLE, function (t) {
			...
			modifiers: {
						...
						return (
							s.forEach(function (a, l) {
								...
								var c = t.offsets.popper,
									...
									h = Math.floor,
									u =
										('left' === i && h(c.right) > h(f.left)) ||
										('right' === i && h(c.left) < h(f.right)) ||
										('top' === i && h(c.bottom) > h(f.top)) ||
										('bottom' === i && h(c.top) < h(f.bottom)),
									d = h(c.left) < h(n.left),
								...
								(u || _ || E) &&
									...
									(t.offsets.popper = ut(
										{},
										t.offsets.popper,
										D(t.instance.popper, t.offsets.reference, t.placement)
									)),
				...
				computeStyle: {
					...
					fn: function (t, e) {
						...
						var s = void 0 !== o ? o : e.gpuAcceleration,
							...
							g = void 0;
						if (
							((g = 'bottom' === h ? -l.height + f.bottom : f.top),
				...
				applyStyle: {
					...
					onLoad: function (t, e, n, i, r) {
						...
						return e.setAttribute('x-placement', s), F(e, { position: 'absolute' }), n;
					},
		...
		_t = (function () {
			function t(e, n) {
				...
				ct(this, t),
					...
					Object.keys(ut({}, t.Defaults.modifiers, o.modifiers)).forEach(function (e) {
	...
	var vt = (function () {
					...
					return (
								...
								if ((r._clearMenus(), !n)) {
									...
									if ((e(t).trigger(o), !o.isDefaultPrevented())) {
										...
										e(t).hasClass(a.DROPUP) &&
											(e(this._menu).hasClass(a.MENULEFT) ||
												e(this._menu).hasClass(a.MENURIGHT)) &&
											(c = t),
											(this._popper = new _t(c, this._menu, this._getPopperConfig())),
											'ontouchstart' in document.documentElement &&
												!e(t).closest(l.NAVBAR_NAV).length &&
												e('body').children().on('mouseover', null, e.noop),
											this._element.focus(),
											this._element.setAttribute('aria-expanded', !0),
											e(this._menu).toggleClass(a.SHOW),
											e(t).toggleClass(a.SHOW).trigger(e.Event(s.SHOWN, i));
									}
								}
							}
						}),
						...
						(u._getConfig = function (n) {
							return (
								...
								X.typeCheckConfig(t, n, this.constructor.DefaultType),
								n
							);
						}),
						...
						(u._getPlacement = function () {
							...
							return (
								t.hasClass(a.DROPUP)
									? ((n = c.TOP), e(this._menu).hasClass(a.MENURIGHT) && (n = c.TOPEND))
									: e(this._menu).hasClass(a.MENURIGHT) && (n = c.BOTTOMEND),
								n
							);
						}),
						...
						(u._getPopperConfig = function () {
							...
							'function' == typeof this._config.offset
								? (n.fn = function (n) {
										return (
											(n.offsets = e.extend({}, n.offsets, t._config.offset(n.offsets) || {})), n
										);
								  })
										...
										if (
											...
											e(c).trigger(d),
												d.isDefaultPrevented() ||
													...
													e(c).removeClass(a.SHOW).trigger(e.Event(s.HIDDEN, h)));
										}
									}
								}
						}),
						...
						(r._dataApiKeydownHandler = function (t) {
							if (
								!(
									...
									(t.preventDefault(),
									t.stopPropagation(),
									this.disabled || e(this).hasClass(a.DISABLED))
								)
							) {
			...
			return (
				e(document)
					.on(s.KEYDOWN_DATA_API, l.DATA_TOGGLE, u._dataApiKeydownHandler)
					.on(s.KEYDOWN_DATA_API, l.MENU, u._dataApiKeydownHandler)
					.on(s.CLICK_DATA_API + ' ' + s.KEYUP_DATA_API, u._clearMenus)
					...
					return (
							...
							if (!this._isTransitioning && !this._isShown) {
								...
								e(this._element).trigger(i),
									this._isShown ||
										...
										e(this._element).on(s.CLICK_DISMISS, l.DATA_DISMISS, function (t) {
											return n.hide(t);
										}),
							...
							if ((t && t.preventDefault(), !this._isTransitioning && this._isShown)) {
								...
								if ((e(this._element).trigger(i), this._isShown && !i.isDefaultPrevented())) {
									...
									r && (this._isTransitioning = !0),
										...
										e(this._dialog).off(s.MOUSEDOWN_DISMISS),
										r
											? e(this._element)
						...
						(c._setEscapeEvent = function () {
							...
							this._isShown && this._config.keyboard
								? e(this._element).on(s.KEYDOWN_DISMISS, function (e) {
						...
						(c._showBackdrop = function (t) {
							...
							if (this._isShown && this._config.backdrop) {
								...
								if (
									...
									e(this._element).on(s.CLICK_DISMISS, function (t) {
								...
								X.supportsTransitionEnd() && e(this._element).hasClass(a.FADE)
									? e(this._backdrop).one(X.TRANSITION_END, o).emulateTransitionEnd(150)
									: o();
							} else t && t();
						}),
					...
					return (
						...
						(d.show = function () {
							...
							if (this.isWithContent() && this._isEnabled) {
								...
								o.setAttribute('id', s),
									...
									this.setContent(),
									this.config.animation && e(o).addClass(f.FADE);
								var a =
								...
								X.supportsTransitionEnd() && e(this.tip).hasClass(f.FADE)
									? e(this.tip).one(X.TRANSITION_END, d).emulateTransitionEnd(i._TRANSITION_DURATION)
									: d();
							}
						}),
						(d.hide = function (t) {
							...
							e(this.element).trigger(r),
								r.isDefaultPrevented() ||
									...
									X.supportsTransitionEnd() && e(this.tip).hasClass(f.FADE)
										? e(i).one(X.TRANSITION_END, o).emulateTransitionEnd(150)
										: o(),
									(this._hoverState = ''));
						}),
						(d.update = function () {
						...
						(d._setListeners = function () {
							...
							this.config.trigger.split(' ').forEach(function (n) {
								...
								this.config.selector
									? (this.config = e.extend({}, this.config, { trigger: 'manual', selector: '' }))
									: this._fixTitle();
						}),
						...
						(d._enter = function (t, n) {
							...
							(n = n || e(t.currentTarget).data(i)) ||
								...
								t && (n._activeTrigger['focusin' === t.type ? u.FOCUS : u.HOVER] = !0),
								e(n.getTipElement()).hasClass(f.SHOW) || n._hoverState === l.SHOW
						...
						(d._leave = function (t, n) {
							...
							(n = n || e(t.currentTarget).data(i)) ||
								((n = new this.constructor(t.currentTarget, this._getDelegateConfig())),
								e(t.currentTarget).data(i, n)),
								t && (n._activeTrigger['focusout' === t.type ? u.FOCUS : u.HOVER] = !1),
						...
						(d._getConfig = function (n) {
							return (
								'number' ==
									typeof (n = e.extend({}, this.constructor.Default, e(this.element).data(), n))
						...
						(i._jQueryInterface = function (t) {
							return this.each(function () {
								...
								if (
									...
									(n || ((n = new i(this, r)), e(this).data('bs.tooltip', n)), 'string' == typeof t)
								) {
					...
					return (
						...
						(h.setContent = function () {
							...
							this.setElementContent(t.find(l.TITLE), this.getTitle()),
								this.setElementContent(t.find(l.CONTENT), this._getContent()),
						...
						(f._jQueryInterface = function (t) {
							return this.each(function () {
								...
								if (
									...
									(n || ((n = new f(this, i)), e(this).data('bs.popover', n)), 'string' == typeof t)
								) {
									if ('undefined' == typeof n[t]) throw new Error('No method named "' + t + '"');
									n[t]();
								}
					...
					return (
						...
						(c._activate = function (t) {
							...
							i.hasClass(s.DROPDOWN_ITEM)
								? (i.closest(a.DROPDOWN).find(a.DROPDOWN_TOGGLE).addClass(s.ACTIVE),
								  i.addClass(s.ACTIVE))
								: (i.addClass(s.ACTIVE),
								  i
								  ...
								  i
										...
										.addClass(s.ACTIVE)),
								e(this._scrollElement).trigger(o.ACTIVATE, { relatedTarget: t });
						}),
						(c._clear = function () {
						...
						(n._jQueryInterface = function (t) {
							return this.each(function () {
								var i = e(this).data('bs.scrollspy'),
									r = 'object' == typeof t && t;
								if (
									(i || ((i = new n(this, r)), e(this).data('bs.scrollspy', i)), 'string' == typeof t)
								) {
									if ('undefined' == typeof i[t]) throw new Error('No method named "' + t + '"');
									i[t]();
								}
				...
				o = (function () {
					...
					return (
						(o.show = function () {
							...
							if (
								...
								if (
									...
									!h.isDefaultPrevented() && !f.isDefaultPrevented())
								) {
						...
						(o._activate = function (t, n, o) {
							...
							l && c ? e(l).one(X.TRANSITION_END, f).emulateTransitionEnd(150) : f(),
						...
						(o._transitionComplete = function (t, n, o, s) {
							...
							if (
								...
								o ? (X.reflow(t), e(t).addClass(i.SHOW)) : e(t).removeClass(i.FADE),
								t.parentNode && e(t.parentNode).hasClass(i.DROPDOWN_MENU))
							) {
								var l = e(t).closest(r.DROPDOWN)[0];
								l && e(l).find(r.DROPDOWN_TOGGLE).addClass(i.ACTIVE),
